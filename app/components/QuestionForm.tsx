  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow-md">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {question.category && categories.find(c => c.name === question.category)?.subcategories && (
          <div>
            <Label htmlFor="subcategory" className="text-gray-700">Subcategory</Label>
            <Select name="subcategory" onValueChange={handleSelectChange('subcategory')}>
              <SelectTrigger className="w-full">
                <SelectValue placeholder="Select a subcategory" />
              </SelectTrigger>
              <SelectContent>
                {categories.find(c => c.name === question.category)?.subcategories?.map((subcategory) => (
        ...
        <div>
          ...
          <Select name="difficulty" onValueChange={handleSelectChange('difficulty')}>
            <SelectTrigger className="w-full">
      ...
      <div>
        <Label htmlFor="solution" className="text-gray-700">Solution</Label>
        <Textarea
          id="solution"
          name="solution"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <Label htmlFor="timeComplexity" className="text-gray-700">Time Complexity</Label>
          <Input
            id="timeComplexity"
            name="timeComplexity"
        ...
        <div>
          <Label htmlFor="spaceComplexity" className="text-gray-700">Space Complexity</Label>
          <Input
            id="spaceComplexity"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <Label htmlFor="sampleInput" className="text-gray-700">Sample Input</Label>
          <Input
            id="sampleInput"
            name="sampleInput"
        ...
        <div>
          <Label htmlFor="sampleOutput" className="text-gray-700">Sample Output</Label>
          <Input
            id="sampleOutput"
            name="sampleOutput"
